...
| `BSEG_BILLED_USAGE_RPT_CURR` | `billed_usage/bseg_billed_usage/01_create_snapshot_table.sql` | `billed_usage/bseg_billed_usage/02a_full_history_refresh_procedure.sql` | `billed_usage/bseg_billed_usage/02_refresh_snapshot_procedure.sql` | `billed_usage/bseg_billed_usage/09_fast_before_after_validation.sql` | `billed_usage/bseg_billed_usage/03_schedule_snapshot_job.sql` | `12 months` |
| `BSEG_SQ_USAGE_RPT_CURR` | `billed_usage/bseg_sq_usage/01_create_snapshot_table.sql` | `billed_usage/bseg_sq_usage/02a_full_history_refresh_procedure.sql` | `billed_usage/bseg_sq_usage/02_refresh_snapshot_procedure.sql` | `billed_usage/bseg_sq_usage/10_fast_before_after_validation.sql` | `billed_usage/bseg_sq_usage/03_schedule_snapshot_job.sql` | `12 months` |
