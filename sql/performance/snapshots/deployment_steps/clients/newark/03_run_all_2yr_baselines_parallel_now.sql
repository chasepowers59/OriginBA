PROMPT ============================================================
PROMPT Newark TEST: pause rolling refreshes, then run all 7
...
BEGIN
    DBMS_SCHEDULER.CREATE_JOB(
        ...
        enabled         => FALSE,
        auto_drop       => FALSE,
        comments        => 'Newark TEST 2yr truncate+reload baseline'
    );
    DBMS_SCHEDULER.CREATE_JOB(
...
PROMPT All 7 Newark 2yr baseline jobs submitted in parallel.
