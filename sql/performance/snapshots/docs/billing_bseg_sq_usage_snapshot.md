...
- `domains/exports/manual_imports/BSEG_SQ_USAGE_RPT_CURR_End_User_Friendly.xml`
...
- `sql/performance/snapshots/docs/snapshot_sqldeveloper_runbook.md` under `BSEG_SQ_USAGE_RPT_CURR`
