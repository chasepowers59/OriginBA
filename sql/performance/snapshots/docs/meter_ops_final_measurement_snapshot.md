...
1. Run the legacy preflight validation in `sql/performance/snapshots/meter_ops/d1_msrmt/00a_legacy_domain_preflight_validation.sql`.
...
- `domains/exports/manual_imports/D1_MSRMT_RPT_CURR_End_User_Friendly.xml`
...
- `sql/performance/snapshots/docs/snapshot_sqldeveloper_runbook.md` under `D1_MSRMT_RPT_CURR`
