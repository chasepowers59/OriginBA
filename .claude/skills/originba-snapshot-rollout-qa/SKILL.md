...
> **The active set is 8 tables** -- FT, BSEG_BILLED_USAGE, BSEG_SQ_USAGE, D1_MSRMT, FT_GL_DISTRIBUTION, D1_USAGE, D1_USAGE_SCALAR_DTL (`*_RPT_CURR`) and CMS_SA_SNAPSHOT -- on a 6-hour stagger from 01:00 (`sql/performance/snapshots/deployment_steps/07_schedule_all_active_snapshots.sql`). The 12 consolidation snapshots were designed 2026-06-11 and never deployed; they and the debt/payments singles are archived (`archive/2026-09-08_reorg/`). The snapshot doc home is `sql/performance/snapshots/docs/`.
