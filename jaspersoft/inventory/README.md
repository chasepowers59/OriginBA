...
| Fond_Du_Lac | 20260918-104538 | 59 | 120 | 229 | 14 | 500 | FondDuLac_DS (JRS2C2M @ smartcity-db-test-v1-2.originsmartops.com:1521), FondDuLac_TST (JRS2C2M @ smartcity-db-test.originsmartops.com:1521) |
...
| Organization | Snapshot | Report units | Domains | Ad Hoc views | Dashboards | Files | Datasources (user @ host) |
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| CityCorp | 20260921-050805 | 88 | 126 | 301 | 14 | 257 | CityCorp_DS (JRS2C2M @ smartcity-db-dr-v1-2.originsmartops.com:1521), AuditDataSource (? @ jdbc), AuditVirtualDataSource (? @ ?), JasperserverDataSource (? @ jdbc), JSDiagnosticDataSource (? @ ?), ReportMonitoringDataSource (? @ jdbc) |
